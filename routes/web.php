...
Route::get('backend/coment/create/{idcoment}', [BackendComentController::class, 'createComentPo'])->name('backend.createcomentpo');

Route::get('backend/coment/{idpost}/coment', [BackendComentController::class, 'showComents'])->name('backend.showcoments');
