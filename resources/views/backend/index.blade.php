...
<html lang="es">
    <head>
        ...
        <title>PostComent Backend | Dashboard</title>
        @yield('prestyle')
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="{{ url('backend') }}" class="brand-link">
                  ...
                  <span class="brand-text font-weight-light">PostComent Backend</span>
                </a>
                <!-- Sidebar -->
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                  <li class="nav-item">
                                    <a href="{{ route('backend.coment.index') }}" class="nav-link ">
                                      <i class="far fa-circle nav-icon"></i>
                                      <p>Ver coments</p>
                                    </a>
                                  </li>
                                  <li class="nav-item">
                                    <a href="{{ route('backend.coment.create') }}" class="nav-link">
                                      <i class="far fa-circle nav-icon"></i>
                                      <p>Añadir coment</p>
                                    </a>
                                  </li>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">PostComent App</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
